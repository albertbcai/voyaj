...
- **[Backlog](BACKLOG.md)** - Prioritized task list and roadmap
- **[Technical Architecture](TECHNICAL_ARCHITECTURE.md)** - Detailed system design
- **[Testing Guide](TESTING_GUIDE.md)** - How to run and understand tests
- **[A2P Compliance](A2P_COMPLIANCE.md)** - SMS compliance documentation
